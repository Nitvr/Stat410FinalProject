...
- JAMB scores have a range from 100 to 400 (and scores above 300 is very rare,) so near the bottom and the top quintile of the data, the residuals might be capped and we'd have issue with Homoscedasticity. Indeed, when we fit an OLS model with the whole data set, we see the Q-Q Residual graph suggesting thinner tails than normal. This is alleviated by discarding the top and bottom 5% of the data.
